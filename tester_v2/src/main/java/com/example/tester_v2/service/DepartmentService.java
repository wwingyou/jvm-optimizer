...
public interface DepartmentService {
    ...
    void setEmployee(String departmentNumber, Integer employeeNumber, DepartmentEmployeeForm form);
    void deleteEmployee(String departmentNumber, Integer employeeNumber);
    void setManager(String departmentNumber, Integer employeeNumber, DepartmentManagerForm form);
